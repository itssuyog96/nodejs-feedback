...
router.post('/submit', function (req, res, next) {
    ...
    for (var key in req.body) {
        if (key.length == 17) {
            ...
            collection.insert({"col_id":col_id, "survey_id":survey_id, "dept_id":dep_id,"sem":sem,"sub_id":a[1],"q_id":a[2],"v_rating":parseFloat(parseFloat(req.body[key]).toFixed(2)), "prof_id" : a[3],"studentOver":""},
                function (er2,result) {
            ...
            collection.insert({"col_id":col_id, "survey_id":survey_id, "dept_id":dep_id,"sem":sem,"sub_id":a[1],"q_id":a[2],"v_rating":parseFloat(parseFloat(req.body[key]).toFixed(2)), "lab_id" : a[3],"studentOver":""},
                function (er2,result) {
                    if (er2) console.log(er2);
                    else {
                    }
            ...
            collection.insert({"col_id":col_id, "survey_id":survey_id, "dept_id":dep_id, "q_id":b[1],"v_rating":parseFloat(parseFloat(req.body[key]).toFixed(2)),"remark":req.body[str],"studentOver":judge},
                function (er,result) {
