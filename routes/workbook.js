...
router.get('/',function (req, res){
    ...
    for(x = 2; x < 3; x++){
        ...
        if(sheet['A' + x.toString()] == undefined)
        {
            ...
            //passwordH1 = MD5(password);
            //passwordH2 = MD5(passwordH1);
            role = "student";
        ...
        collection.insert({"col_id":"32132","dept_id":"23","roll_no": roll_no,"name": name,"sem":"4","contact":contact,"email_id":email_id, "role":role, "uid":uid, "nameH":nameH, "password":passwordH1, "passwordH":passwordH2},function(e,docs){
